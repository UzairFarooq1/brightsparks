...
import { Code2, FolderRoot as Football, Palette, Music, Zap, Gamepad2, Trophy, Users, Clock, Star } from 'lucide-react';
  ...
  const activities = [
    {
      ...
      benefits: ["Problem-solving skills", "Logical thinking", "Future career preparation"]
    },
    {
      icon: Football,
      title: "Football",
    ...
    },
    {
      ...
      benefits: ["Balance & coordination", "Confidence building", "Physical fitness"]
    },
    {
      icon: Zap,
      title: "Horse Riding",
  ...
  return (
    <div className="pt-20">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-800 mb-4">Our Activity Programs</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Each activity is designed to complement academic learning while fostering 
              ...
              <div key={index} className="bg-gray-50 p-6 rounded-lg hover:shadow-lg transition-shadow">
                ...
                <div className="space-y-3 mb-4">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-gray-700 text-sm font-medium">{activity.schedule}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-gray-500">Level:</span>
                    <span className="text-gray-700 text-sm font-medium">{activity.level}</span>
                  </div>
                </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-800 mb-4">Activity Categories</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our activities are organized into different categories to ensure comprehensive 
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-orange-500 to-red-500 text-white p-8 rounded-lg">
              <h3 className="text-2xl font-bold mb-4">Sports & Physical Activities</h3>
            ...
            <div className="bg-gradient-to-br from-purple-500 to-pink-500 text-white p-8 rounded-lg">
              <h3 className="text-2xl font-bold mb-4">Creative Arts & Technology</h3>
              <p className="text-purple-100 mb-6">
                Nurture creativity and artistic expression through various art forms and modern technology. 
                Students explore their talents and showcase their work in exhibitions and performances.
              </p>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-800 mb-4">Activity Achievements</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our commitment to excellence in extracurricular activities is reflected in 
              our students' achievements and participation rates.
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-green-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-6">Join Our Activity Programs</h2>
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Give your child the opportunity to explore their interests, develop new skills, 
            and make lasting friendships through our diverse activity programs.
          </p>
