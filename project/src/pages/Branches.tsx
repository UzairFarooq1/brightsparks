...
import { MapPin, Phone, Clock, Star, Users, Award, Building } from 'lucide-react';
  ...
  const branches = [
    {
      ...
      established: "Main Branch - Founded 2010",
      description: "Our flagship campus with state-of-the-art facilities and the most experienced staff.",
      features: [
        "Modern computer lab",
        "Science laboratory",
    ...
    },
    {
      ...
      description: "Modern campus serving the Parklands community with excellent facilities and programs.",
      features: [
    ...
    },
    {
      ...
      established: "Expanding Location - 2020",
      description: "Our newest branch offering modern amenities and innovative learning environments.",
      features: [
        "Modern classrooms",
                  ...
                  <div className="grid grid-cols-3 gap-2 mb-6">
                    {branch.highlights.map((highlight, hIndex) => (
                      <div key={hIndex} className="text-center">
                        ...
                        <p className="text-xs text-gray-600">{highlight.text}</p>
                      </div>
                    ))}
                  </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-gray-800 mb-6">Visit Our Campuses</h2>
              ...
              <p className="text-gray-600 mb-8 leading-relaxed">
                Our campuses are strategically located across Nairobi to serve families 
                in different areas while maintaining the same high standards of education 
                and care that Bright Sparks School is known for.
              </p>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-blue-50 p-6 rounded-lg">
                ...
                <p className="text-gray-600 mb-3">
                  All our branches are easily accessible by public transport and have 
                  designated parking areas for parents.
                </p>
                <ul className="space-y-2">
                  <li className="flex items-start">
                    <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 mr-3"></div>
                    <span className="text-gray-600 text-sm">School transport available</span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 mr-3"></div>
                    <span className="text-gray-600 text-sm">Safe drop-off zones</span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 mr-3"></div>
                    <span className="text-gray-600 text-sm">Secure parking facilities</span>
                  </li>
                </ul>
              </div>
            </div>
