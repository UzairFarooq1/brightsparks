    ...
    <section id="curriculum" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-800 mb-4">Our Curriculum</h2>
        ...
        <div className="bg-gradient-to-br from-blue-600 to-green-600 text-white p-8 rounded-lg">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h3 className="text-3xl font-bold mb-4">Education Levels We Offer</h3>
              <p className="text-blue-100 mb-6 leading-relaxed">
                From early childhood development to secondary education, we provide 
                continuous learning pathways for students at every stage of their 
                educational journey.
              </p>
            </div>
